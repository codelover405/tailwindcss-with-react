        ...
        <>
            <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
                <div className={`flex-1 flex-col ${styles.flexStart} xl:px-0 sm:px-16 px-6`}>
                    ...
                    <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugit accusantium tempore corporis nesciunt unde, perferendis voluptatem ducimus iste aperiam amet voluptatum quo eligendi cupiditate commodi. Praesentium nostrum nemo obcaecati asperiores!</p>
                </div>
